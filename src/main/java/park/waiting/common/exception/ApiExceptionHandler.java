...
import park.waiting.common.dto.ApiErrorResponse;

import javax.validation.ConstraintViolationException;

@RestControllerAdvice(annotations = {RestController.class})
public class ApiExceptionHandler extends ResponseEntityExceptionHandler { // Spring MVC 사용시 발생하는 Exception을 잡기 위해서 상속
    ...
    // ResponseEntityExceptionHandler에서 제공하는 handleExceptionInternal는 body가 null로 나옴 -> override 필요
    @Override
